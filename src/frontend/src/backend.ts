...
export class Backend implements backendInterface {
    ...
    async getLossHistory(): Promise<Array<LossEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLossHistory();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getLossSurface(arg0: bigint): Promise<Array<LossSurfacePoint>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLossSurface(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initialize(arg0: number, arg1: number): Promise<void> {
        if (this.processError) {
            try {
    ...
    async step(arg0: number): Promise<StepResult> {
        if (this.processError) {
            try {
                const result = await this.actor.step(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
